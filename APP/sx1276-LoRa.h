...
#define NORMALSYMBOLSLENGTH      32
#define HALF_SLEEP_PERIOD        1000 //ms
...
typedef enum
{
    ...
    RFLR_STATE_CAD_SUCCESS,
    RFLR_STATE_CAD_FAIALED,
    /* BEGIN: Added by Barry, 2014/3/5 */
    RFLR_STATE_RX_RECEIVEING,
...
typedef struct
{
	u8	          rf_DataBuffer[255];
	bool		  rf_DataBufferValid;
	tRFLRStates       rf_state;
	u8	          rf_RxPacketSize;
	u8	          rf_TxPacketSize;
	bool		  rf_HeaderValid;
	bool		  rf_wakeUpTx;
...
/* BEGIN: Added by Barry, 2014/3/5 */
#define RFLR_IRQFLAGS_ALL_MASK                      0xFF 
...
typedef enum
{
  ...
  DIO0_RxDone            = RFLR_DIOMAPPING1_DIO0_00,                                                
  DIO0_TxDone            = RFLR_DIOMAPPING1_DIO0_01,                                                
  DIO0_CadDone           = RFLR_DIOMAPPING1_DIO0_10,                                                
  DIO0_unused            = RFLR_DIOMAPPING1_DIO0_11,                                                
                                                                                                    
                                                                                                    
  DIO1_RxTimeout         = RFLR_DIOMAPPING1_DIO1_00,                                                
  DIO1_FhssCC            = RFLR_DIOMAPPING1_DIO1_01,                                                
  DIO1_CadDetected       = RFLR_DIOMAPPING1_DIO1_10,                                                
  DIO1_unused            = RFLR_DIOMAPPING1_DIO1_11,                                                
                                                                                                    
                                                                                                    
  DIO2_FhssCC            = RFLR_DIOMAPPING1_DIO2_00,                                                
  //DIO2_FhssCC            = RFLR_DIOMAPPING1_DIO2_01,                                                
  //DIO2_FhssCC            = RFLR_DIOMAPPING1_DIO2_10,                                                
  DIO2_unused            = RFLR_DIOMAPPING1_DIO2_11,                                                
                                                                                                    
                                                                                                    
  DIO3_CadDone           = RFLR_DIOMAPPING1_DIO3_00,                                                
  DIO3_ValidHeader       = RFLR_DIOMAPPING1_DIO3_01,                                                
  DIO3_PayloadCrcError   = RFLR_DIOMAPPING1_DIO3_10,                                                
  DIO3_unused            = RFLR_DIOMAPPING1_DIO3_11,                                                
                                                                                                    
                                                                                                    
  DIO4_CadDetected       = RFLR_DIOMAPPING2_DIO4_00,                                                
  DIO4_PllLock           = RFLR_DIOMAPPING2_DIO4_01,                                                
  //DIO4_PllLock           = RFLR_DIOMAPPING2_DIO4_10,                                                
  DIO4_unused            = RFLR_DIOMAPPING2_DIO4_11,                                                
                                                                                                    
                                                                                                    
  DIO5_ModeReady         = RFLR_DIOMAPPING2_DIO5_00,                                                
  DIO5_ClkOut            = RFLR_DIOMAPPING2_DIO5_01,                                                
  //DIO5_ClkOut            = RFLR_DIOMAPPING2_DIO5_10,                                                
  DIO5_unused            = RFLR_DIOMAPPING2_DIO5_11,                                                                                                                                                    
}em_GDOxMap_typeDef;


typedef struct
{
  em_GDOxMap_typeDef GDO0Config;
  em_GDOxMap_typeDef GDO1Config;
  em_GDOxMap_typeDef GDO2Config;
  em_GDOxMap_typeDef GDO3Config;
  em_GDOxMap_typeDef GDO4Config;
  em_GDOxMap_typeDef GDO5Config;
}st_GDOx_Config;
 ...
 * \param [IN]: size       Buffer size
 */
//void SX1276LoRaSetTxPacket( u8  * buffer, u16 size );
...
/*
void write_LoRa_state(tRFLRStates cuState);
tRFLRStates read_LoRa_state(void);
void readTest(void);
...
void SX1276LoRaSetPacketRxGain( uint8_t inputValue);
void SX1276LoRaSetPacketSnr( int8_t inputValue);
void SX1276LoRaSetPacketRssi( double inputValue);
