#ifndef __HAL_FSK_SEN_H__
#define __HAL_FSK_SEN_H__
...
#define TX_FIFO_THRESHOLD                            10
#define RX_FIFO_THRESHOLD                            34

#define FIFO_LENGTH                                  64

typedef enum
{
    packet_DIO0_packetSend          = RF_DIOMAPPING1_DIO0_00,
    packet_DIO0_RxpayloadReady      = RF_DIOMAPPING1_DIO0_00,

    packet_DIO1_fifoLevel           = RF_DIOMAPPING1_DIO1_00,
    packet_DIO1_fifoEmpty           = RF_DIOMAPPING1_DIO1_01,
    packet_DIO1_fifoFull            = RF_DIOMAPPING1_DIO1_10,

    packet_DIO2_fifoFull            = RF_DIOMAPPING1_DIO2_00,
    packet_DIO2_RxReady             = RF_DIOMAPPING1_DIO2_01,
    packet_DIO2_RxTimeOut           = RF_DIOMAPPING1_DIO2_10,
    packet_DIO2_SyncAddress         = RF_DIOMAPPING1_DIO2_11,

    packet_DIO3_fifoEmpty           = RF_DIOMAPPING1_DIO3_00,
    packet_DIO3_TxReady             = RF_DIOMAPPING1_DIO3_01,

    packet_DIO4_PllLock             = RF_DIOMAPPING2_DIO4_01,
    packet_DIO4_TimeOut             = RF_DIOMAPPING2_DIO4_10,
    packet_DIO4_Rssi_PreambleDetect = RF_DIOMAPPING2_DIO4_11,

    packet_DIO5_ClkOut              = RF_DIOMAPPING2_DIO5_00,
    packet_DIO5_Data                = RF_DIOMAPPING2_DIO5_01,

    continuous_DIO1_Dclk            = RF_DIOMAPPING1_DIO1_00,
    continuous_DIO2_Data            = RF_DIOMAPPING1_DIO2_00,   
}em_FskDIOx_Map;
