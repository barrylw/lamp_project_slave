///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.3.6832/W32 for ARM       11/Dec/2015  17:46:34
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\svnProject\street_lamp_new\LIB\STM32F0xx_StdPeriph_Driver\src\stm32f0xx_i2c.c
//    Command line =  
//        E:\svnProject\street_lamp_new\LIB\STM32F0xx_StdPeriph_Driver\src\stm32f0xx_i2c.c
...
//    List file    =  E:\svnProject\street_lamp_new\Debug\List\stm32f0xx_i2c.s
//
///////////////////////////////////////////////////////////////////////////////
...
??I2C_DualAddressCmd_0:
        LDR      R1,[R0, #+12]
        LDR      R2,??DataTable22_1  ;; 0xffff7fff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+12]
...
??I2C_GeneralCallCmd_0:
        LDR      R1,[R0, #+0]
        LDR      R2,??DataTable23_1  ;; 0xfff7ffff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+0]
...
??I2C_SlaveByteControlCmd_0:
        LDR      R1,[R0, #+0]
        LDR      R2,??DataTable23_2  ;; 0xfffeffff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+0]
...
??I2C_10BitAddressingModeCmd_0:
        LDR      R1,[R0, #+4]
        LDR      R2,??DataTable23_3  ;; 0xfffff7ff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+4]
...
??I2C_AutoEndCmd_0:
        LDR      R1,[R0, #+4]
        LDR      R2,??DataTable23_4  ;; 0xfdffffff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+4]
??I2C_AutoEndCmd_1:
        POP      {PC}             ;; return
...
??I2C_ReloadCmd_0:
        LDR      R1,[R0, #+4]
        LDR      R2,??DataTable23_5  ;; 0xfeffffff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+4]
??I2C_ReloadCmd_1:
        POP      {PC}             ;; return
...
I2C_MasterRequestConfig:
        ...
        LDR      R1,[R0, #+4]
        LDR      R2,??DataTable23_7  ;; 0xfffffbff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+4]
...
??I2C_GenerateSTART_0:
        LDR      R1,[R0, #+4]
        LDR      R2,??DataTable23_8  ;; 0xffffdfff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+4]
??I2C_GenerateSTART_1:
        POP      {PC}             ;; return
...
??I2C_GenerateSTOP_0:
        LDR      R1,[R0, #+4]
        LDR      R2,??DataTable23_9  ;; 0xffffbfff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+4]
??I2C_GenerateSTOP_1:
        POP      {PC}             ;; return
...
??I2C_10BitAddressHeaderCmd_0:
        LDR      R1,[R0, #+4]
        LDR      R2,??DataTable23_10  ;; 0xffffefff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+4]
...
I2C_TransferHandling:
        ...
        MOVS     R4,R5
        MOVS     R5,R4
        LDR      R4,??DataTable23_11  ;; 0xfc009800
        ANDS     R4,R4,R5
        MOVS     R5,R4
        UXTH     R1,R1
...
??I2C_SMBusAlertCmd_0:
        LDR      R1,[R0, #+0]
        LDR      R2,??DataTable23_12  ;; 0xffbfffff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+0]
??I2C_SMBusAlertCmd_1:
        POP      {PC}             ;; return
...
??I2C_CalculatePEC_0:
        LDR      R1,[R0, #+0]
        LDR      R2,??DataTable23_15  ;; 0xff7fffff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+0]
??I2C_CalculatePEC_1:
        POP      {PC}             ;; return
...
??I2C_PECRequestCmd_0:
        LDR      R1,[R0, #+0]
        LDR      R2,??DataTable23_16  ;; 0xfbffffff
        ANDS     R2,R2,R1
        STR      R2,[R0, #+0]
??I2C_PECRequestCmd_1:
        POP      {PC}             ;; return
