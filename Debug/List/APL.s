///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.3.6832/W32 for ARM       11/Dec/2015  17:46:10
...
NVIC_SystemReset:
        PUSH     {LR}
        DSB      
        LDR      R0,??DataTable2  ;; 0x5fa0004
        LDR      R1,??DataTable3  ;; 0xe000ed0c
        STR      R0,[R1, #+0]
        DSB      
??NVIC_SystemReset_0:
...
`?<Constant "update_process ">`:
        ...
        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
`?<Constant "the same version\\r\\n">`:
        DATA
        DC8 "the same version\015\012"
        DC8 0
...
aplVersion:
        DATA
        DC8 66, 82, 50, 51, 48, 1, 20, 0, 6, 0, 0, 0
...
??process_thread_apl_update_process_7:
        ...
        LDRB     R0,[R0, #+10]
        CMP      R0,#+1
        BEQ      ??process_thread_apl_update_process_8
        B        ??process_thread_apl_update_process_0
...
??process_thread_apl_update_process_11:
        ...
        LDRB     R0,[R0, #+0]
        CMP      R0,#+1
        BEQ      ??process_thread_apl_update_process_9
        B        ??process_thread_apl_update_process_0
...
read_update_flash:
        PUSH     {R4,LR}
        MOVS     R4,R0
        LDR      R1,??DataTable10_4  ;; 0x800f400
        LDRB     R0,[R1, #+0]
        MOVS     R2,#+128
        LSLS     R2,R2,#+1        ;; #+256
        MULS     R0,R2,R0
...
write_update_flash:
        ...
        ADDS     R1,R1,#+136
        STRB     R0,[R1, #+0]
        LDR      R0,??DataTable10_4  ;; 0x800f400
        BL       FLASH_ErasePage
        CMP      R0,#+4
...
??DataTable4_2:
        ...
        DATA
??DataTable4_3:
        DC32     `?<Constant "the same version\\r\\n">`
...
write_finish_debug:
        ...
        MOV      R1,SP
        STRH     R0,[R1, #+8]
        LDR      R0,??DataTable11  ;; 0x2cf
        MOV      R1,SP
        STRH     R0,[R1, #+4]
        LDR      R0,??DataTable11_1  ;; 0xb3d6
        MOV      R1,SP
        STRH     R0,[R1, #+0]
        MOVS     R0,#+180
        LSLS     R0,R0,#+2        ;; #+720
...
??check_update_state_0:
        ...
        UXTH     R4,R4
        CMP      R5,R4
        BCS      ??check_update_state_2
        MOVS     R0,R5
        UXTH     R0,R0
        BL       check_update_packect_state
        CMP      R0,#+0
        BNE      ??check_update_state_1
        MOVS     R0,#+0
...
??printf_params_0:
        ...
        CMP      R4,#+128
        BLT      ??printf_params_1
        ADR      R0,??DataTable12_11  ;; 0x0D, 0x0A, 0x00, 0x00
        BL       printf
        POP      {R4,PC}          ;; return
