///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.3.6832/W32 for ARM       11/Dec/2015  17:46:36
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\svnProject\street_lamp_new\LIB\STM32F0xx_StdPeriph_Driver\src\stm32f0xx_rcc.c
//    Command line =  
//        E:\svnProject\street_lamp_new\LIB\STM32F0xx_StdPeriph_Driver\src\stm32f0xx_rcc.c
...
//    List file    =  E:\svnProject\street_lamp_new\Debug\List\stm32f0xx_rcc.s
//
///////////////////////////////////////////////////////////////////////////////
...
RCC_DeInit:
        ...
        STR      R0,[R1, #+0]
        LDR      R0,??DataTable20  ;; 0x40021030
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable20_1  ;; 0xfffffeac
        ANDS     R1,R1,R0
        LDR      R0,??DataTable20  ;; 0x40021030
        STR      R1,[R0, #+0]
        LDR      R0,??DataTable20_2  ;; 0x40021034
        LDR      R0,[R0, #+0]
        MOVS     R1,#+1
        BICS     R0,R0,R1
        LDR      R1,??DataTable20_2  ;; 0x40021034
        STR      R0,[R1, #+0]
        MOVS     R0,#+0
...
RCC_AdjustHSI14CalibrationValue:
        MOVS     R1,#+0
        LDR      R2,??DataTable20_2  ;; 0x40021034
        LDR      R2,[R2, #+0]
        MOVS     R1,R2
        MOVS     R2,#+248
        BICS     R1,R1,R2
...
??RCC_PLLCmd_0:
        LDR      R0,??DataTable18  ;; 0x40021000
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable24_1  ;; 0xfeffffff
        ANDS     R1,R1,R0
        LDR      R0,??DataTable18  ;; 0x40021000
        STR      R1,[R0, #+0]
??RCC_PLLCmd_1:
...
??DataTable18_5:
        ...
        THUMB
RCC_ADCCLKConfig:
        LDR      R1,??DataTable30  ;; 0x40021004
        LDR      R1,[R1, #+0]
        LDR      R2,??DataTable30_1  ;; 0xffffbfff
        ANDS     R2,R2,R1
        LDR      R1,??DataTable30  ;; 0x40021004
        STR      R2,[R1, #+0]
        LDR      R1,??DataTable30  ;; 0x40021004
        ...
        LDR      R1,??DataTable30  ;; 0x40021004
        STR      R2,[R1, #+0]
        LDR      R1,??DataTable20  ;; 0x40021030
        LDR      R1,[R1, #+0]
        LDR      R2,??DataTable31  ;; 0xfffffeff
        ANDS     R2,R2,R1
        LDR      R1,??DataTable20  ;; 0x40021030
        STR      R2,[R1, #+0]
        LDR      R1,??DataTable20  ;; 0x40021030
...
??DataTable20_2:
        ...
        THUMB
RCC_I2CCLKConfig:
        LDR      R1,??DataTable33  ;; 0x40021030
        LDR      R1,[R1, #+0]
        MOVS     R2,#+16
        BICS     R1,R1,R2
        LDR      R2,??DataTable33  ;; 0x40021030
        STR      R1,[R2, #+0]
        LDR      R1,??DataTable33  ;; 0x40021030
        LDR      R1,[R1, #+0]
        ORRS     R0,R0,R1
...
??RCC_GetClocksFreq_0:
        LDR      R0,??DataTable36  ;; 0x7a1200
        STR      R0,[R4, #+0]
        B        ??RCC_GetClocksFreq_4
??RCC_GetClocksFreq_1:
        LDR      R0,??DataTable34  ;; 0xf42400
        STR      R0,[R4, #+0]
        B        ??RCC_GetClocksFreq_4
??RCC_GetClocksFreq_2:
        LDR      R0,??DataTable30  ;; 0x40021004
...
RCC_RTCCLKCmd:
        ...
        CMP      R0,#+0
        BEQ      ??RCC_RTCCLKCmd_0
        LDR      R0,??DataTable37_3  ;; 0x40021020
        LDR      R0,[R0, #+0]
        MOVS     R1,#+128
        LSLS     R1,R1,#+8        ;; #+32768
        ORRS     R1,R1,R0
...
??RCC_RTCCLKCmd_0:
        LDR      R0,??DataTable37_3  ;; 0x40021020
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable37_4  ;; 0xffff7fff
        ANDS     R1,R1,R0
        LDR      R0,??DataTable37_3  ;; 0x40021020
        STR      R1,[R0, #+0]
??RCC_RTCCLKCmd_1:
...
??RCC_BackupResetCmd_0:
        LDR      R0,??DataTable37_3  ;; 0x40021020
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable37_5  ;; 0xfffeffff
        ANDS     R1,R1,R0
        LDR      R0,??DataTable37_3  ;; 0x40021020
        STR      R1,[R0, #+0]
...
RCC_AHBPeriphClockCmd:
        ...
        LDR      R1,??DataTable37_6  ;; 0x40021014
        LDR      R1,[R1, #+0]
        ORRS     R0,R0,R1
        LDR      R1,??DataTable37_6  ;; 0x40021014
        STR      R0,[R1, #+0]
...
??RCC_AHBPeriphClockCmd_0:
        ...
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR      R0,??DataTable37_6  ;; 0x40021014
        STR      R1,[R0, #+0]
...
RCC_APB2PeriphClockCmd:
        ...
        LDR      R1,??DataTable37_7  ;; 0x40021018
        LDR      R1,[R1, #+0]
        ORRS     R0,R0,R1
        LDR      R1,??DataTable37_7  ;; 0x40021018
        STR      R0,[R1, #+0]
...
??RCC_APB2PeriphClockCmd_0:
        ...
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR      R0,??DataTable37_7  ;; 0x40021018
        STR      R1,[R0, #+0]
...
RCC_APB1PeriphClockCmd:
        ...
        LDR      R1,??DataTable37_8  ;; 0x4002101c
        LDR      R1,[R1, #+0]
        ORRS     R0,R0,R1
        LDR      R1,??DataTable37_8  ;; 0x4002101c
        STR      R0,[R1, #+0]
...
??RCC_APB1PeriphClockCmd_0:
        ...
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR      R0,??DataTable37_8  ;; 0x4002101c
        STR      R1,[R0, #+0]
...
RCC_AHBPeriphResetCmd:
        ...
        LDR      R1,??DataTable37_9  ;; 0x40021028
        LDR      R1,[R1, #+0]
        ORRS     R0,R0,R1
        LDR      R1,??DataTable37_9  ;; 0x40021028
        STR      R0,[R1, #+0]
...
??RCC_AHBPeriphResetCmd_0:
        ...
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR      R0,??DataTable37_9  ;; 0x40021028
        STR      R1,[R0, #+0]
...
RCC_APB2PeriphResetCmd:
        ...
        LDR      R1,??DataTable37_10  ;; 0x4002100c
        LDR      R1,[R1, #+0]
        ORRS     R0,R0,R1
        LDR      R1,??DataTable37_10  ;; 0x4002100c
        STR      R0,[R1, #+0]
...
??RCC_APB2PeriphResetCmd_0:
        ...
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR      R0,??DataTable37_10  ;; 0x4002100c
        STR      R1,[R0, #+0]
...
RCC_APB1PeriphResetCmd:
        ...
        LDR      R1,??DataTable37_11  ;; 0x40021010
        LDR      R1,[R1, #+0]
        ORRS     R0,R0,R1
        LDR      R1,??DataTable37_11  ;; 0x40021010
        STR      R0,[R1, #+0]
...
??RCC_APB1PeriphResetCmd_0:
        ...
        LDR      R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR      R0,??DataTable37_11  ;; 0x40021010
        STR      R1,[R0, #+0]
...
RCC_ITConfig:
        ...
        CMP      R1,#+0
        BEQ      ??RCC_ITConfig_0
        LDR      R1,??DataTable37_12  ;; 0x40021009
        LDRB     R1,[R1, #+0]
        ORRS     R0,R0,R1
        LDR      R1,??DataTable37_12  ;; 0x40021009
        STRB     R0,[R1, #+0]
...
??RCC_ITConfig_0:
        ...
        LDRB     R1,[R1, #+0]
        BICS     R1,R1,R0
        LDR      R0,??DataTable37_12  ;; 0x40021009
        STRB     R1,[R0, #+0]
??RCC_ITConfig_1:
        POP      {PC}             ;; return
...
RCC_GetFlagStatus:
        ...
        LDR      R1,??DataTable37_13  ;; 0x40021000
        LDR      R2,[R1, #+0]
...
??RCC_GetFlagStatus_2:
        ...
        LDR      R1,??DataTable37_14  ;; 0x40021024
        LDR      R2,[R1, #+0]
        B        ??RCC_GetFlagStatus_1
??RCC_GetFlagStatus_3:
        LDR      R1,??DataTable37_15  ;; 0x40021034
        LDR      R2,[R1, #+0]
??RCC_GetFlagStatus_1:
        UXTB     R0,R0
