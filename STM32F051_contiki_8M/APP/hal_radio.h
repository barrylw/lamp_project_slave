...
#define sRF_RESET_PORT                          GPIOF 
#define sRF_RESET_PIN                           GPIO_Pin_7
#define sRF_RESET_SCK                           RCC_AHBPeriph_GPIOF

#define sRF_DIOx_PORT                           GPIOA
#define sRF_DIOx_SCK                            RCC_AHBPeriph_GPIOA
#define sRF_DIO0_PIN                            GPIO_Pin_15
#define sRF_DIO1_PIN                            GPIO_Pin_12
#define sRF_DIO2_PIN                            GPIO_Pin_11
#define sRF_DIO3_PIN                            GPIO_Pin_10
#define sRF_DIO4_PIN                            GPIO_Pin_8

#define sRF_DIOx_PORT_SOURCE                    EXTI_PortSourceGPIOA

#define sRF_DIO0_PIN_SOURCE                     EXTI_PinSource15 //GPIO_PinSource0
#define sRF_DIO1_PIN_SOURCE                     EXTI_PinSource12 //GPIO_PinSource1
#define sRF_DIO2_PIN_SOURCE                     EXTI_PinSource11 //GPIO_PinSource2
#define sRF_DIO3_PIN_SOURCE                     EXTI_PinSource10 //GPIO_PinSource11
#define sRF_DIO4_PIN_SOURCE                     EXTI_PinSource8  //GPIO_PinSource10
    
#define  DIO0_IRQ                               EXTI_Line15
#define  DIO1_IRQ                               EXTI_Line12
#define  DIO2_IRQ                               EXTI_Line11
#define  DIO3_IRQ                               EXTI_Line10
#define  DIO4_IRQ                               EXTI_Line8
