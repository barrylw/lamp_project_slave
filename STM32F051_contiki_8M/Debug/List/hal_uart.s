///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.3.6832/W32 for ARM       15/Sep/2015  17:19:53
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  F:\meterModuleFSK\STM32F051_contiki_8M\APP\hal_uart.c
//    Command line =  
//        F:\meterModuleFSK\STM32F051_contiki_8M\APP\hal_uart.c -D
...
//    List file    =  
//        F:\meterModuleFSK\STM32F051_contiki_8M\Debug\List\hal_uart.s
//
///////////////////////////////////////////////////////////////////////////////
...
??process_thread_hal_urat_process_11:
        LDR      R0,??DataTable4_4
        CMP      R5,R0
        BNE      ??process_thread_hal_urat_process_12
        MOVS     R0,#+0
        LDR      R1,??DataTable5_6
        STRH     R0,[R1, #+0]
        MOVS     R0,#+6
        ...
        LDR      R0,??DataTable5_8
        BL       hal_DebugDMATx
??process_thread_hal_urat_process_12:
        LDR      R0,??DataTable5_1
        CMP      R5,R0
        BNE      ??process_thread_hal_urat_process_0
        MOVS     R0,#+10
...
hal_DebugDMATx:
        ...
        MOVS     R4,R0
??hal_DebugDMATx_1:
        LDR      R0,??DataTable10_1  ;; 0x4002001c
        BL       DMA_DeInit
...
USART1_IRQHandler:
        PUSH     {R4,LR}
        LDR      R1,??DataTable10_7  ;; 0x50105
        LDR      R0,??DataTable12_1  ;; 0x40013800
        BL       USART_GetITStatus
        CMP      R0,#+0
...
DMA1_Channel2_3_IRQHandler:
        ...
        BL       DMA_GetITStatus
        CMP      R0,#+0
        BEQ      ??DMA1_Channel2_3_IRQHandler_0
        MOVS     R0,#+32
        ...
        UXTB     R4,R4
        CMP      R4,#+0
        BNE      ??DMA1_Channel2_3_IRQHandler_0
        LDR      R0,??DataTable12_5
        LDRB     R0,[R0, #+1]
        ADDS     R0,R0,#+1
        LDR      R1,??DataTable12_5
        ...
        LDRB     R0,[R0, #+1]
        CMP      R0,#+50
        BLT      ??DMA1_Channel2_3_IRQHandler_1
        MOVS     R0,#+0
        LDR      R1,??DataTable12_5
        STRB     R0,[R1, #+1]
??DMA1_Channel2_3_IRQHandler_1:
        LDR      R0,??DataTable12_5
        LDRB     R0,[R0, #+1]
        LDR      R1,??DataTable12_5
        LDRB     R1,[R1, #+0]
        CMP      R0,R1
        BEQ      ??DMA1_Channel2_3_IRQHandler_2
        MOVS     R0,#+8
        ...
        BL       etimer_remodify
        B        ??DMA1_Channel2_3_IRQHandler_0
??DMA1_Channel2_3_IRQHandler_2:
        MOVS     R0,#+9
        LDR      R1,??DataTable12_7
        STRB     R0,[R1, #+0]
        ...
        BL       process_post
??DMA1_Channel2_3_IRQHandler_0:
        MOVS     R0,#+128
        BL       DMA_GetITStatus
        CMP      R0,#+0
        BEQ      ??DMA1_Channel2_3_IRQHandler_3
        MOVS     R0,#+128
        BL       DMA_ClearITPendingBit
        MOVS     R0,#+10
        LDR      R1,??DataTable12_7
