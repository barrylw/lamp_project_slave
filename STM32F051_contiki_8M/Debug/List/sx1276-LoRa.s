///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.3.6832/W32 for ARM       17/Nov/2015  16:19:31
...
SX1276LoRaGetTimeOnAir:
        ...
        BL       __aeabi_ui2d
        MOVS     R2,#+0
        LDR      R3,??DataTable19_1  ;; 0x40110000
        BL       __aeabi_dadd
        ADD      R2,SP,#+8
        STM      R2!,{R0,R1}
        SUBS     R2,R2,#+8
...
SX1276LoRaSetWokeUpPreambleLenth:
        ...
        BL       __aeabi_ui2d
        MOVS     R2,#+0
        LDR      R3,??DataTable19_3  ;; 0x3ff00000
        BL       __aeabi_dmul
        MOVS     R2,R4
        MOVS     R3,R5
        BL       __aeabi_ddiv
        MOVS     R2,#+0
        LDR      R3,??DataTable19_4  ;; 0x40340000
        BL       __aeabi_dadd
        BL       __aeabi_d2uiz
        LDR      R1,??DataTable22
        STR      R0,[R1, #+0]
...
SX1276LoRaGetTxTimeOut:
        ...
        MOVS     R2,#+0
        LDR      R3,??DataTable22_1  ;; 0x3ff80000
        BL       __aeabi_dmul
        BL       __aeabi_d2uiz
        POP      {R1,PC}          ;; return
...
SX1276LoRaReadRssi:
        ...
        LDR      R0,??DataTable18
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable24_4  ;; 0x33428f00
        CMP      R0,R1
        ...
        BL       __aeabi_ui2d
        MOVS     R2,#+0
        LDR      R3,??DataTable24_5  ;; 0xc0648000
        BL       __aeabi_dadd
...
get_RxPacketRssi:
        ...
        MOVS     R4,#+0
        LDR      R5,??DataTable24_5  ;; 0xc0648000
        B        ??get_RxPacketRssi_1
??get_RxPacketRssi_0:
        MOVS     R4,#+0
        LDR      R5,??DataTable25  ;; 0xc063a000
??get_RxPacketRssi_1:
        LDR      R0,??DataTable24_2
        MOVS     R1,#+0
        LDRSB    R0,[R0, R1]
...
SX1276LoRaInit:
        ...
        BL       SX1276LoRaGetSymbolTs
        MOVS     R2,#+0
        LDR      R3,??DataTable26_1  ;; 0x40300000
        BL       __aeabi_cdrcmple
...
??EXTI0_1_IRQHandler_3:
        ...
        BL       SX1276Read
        BL       get_RxPacketRssi
        LDR      R2,??DataTable29_5
        STM      R2!,{R0,R1}
        SUBS     R2,R2,#+8
        BL       getPacketSnr
        LDR      R1,??DataTable29_6
        STRB     R0,[R1, #+0]
        LDR      R0,??DataTable28
        LDR      R0,[R0, #+0]
        LDRB     R0,[R0, #+18]
...
EXTI4_15_IRQHandler:
        ...
        MOVS     R0,#+28
        BL       SX1276Read
        LDR      R0,??DataTable29_10
        LDRB     R0,[R0, #+0]
        LDR      R1,??DataTable29_8
        LDR      R1,[R1, #+0]
        LDRB     R1,[R1, #+28]
        ADDS     R0,R0,R1
        LSLS     R0,R0,#+26       ;; ZeroExtS R0,R0,#+26,#+26
...
??EXTI4_15_IRQHandler_1:
        ...
        BL       EXTI_ClearITPendingBit
        MOVS     R1,#+1
        LDR      R0,??DataTable29_13  ;; 0x40002000
        BL       TIM_Cmd
        MOVS     R1,#+0
        LDR      R0,??DataTable29_13  ;; 0x40002000
        BL       TIM_SetCounter
...
// 2 888 bytes in section .text
// 
// 2 888 bytes of CODE  memory
