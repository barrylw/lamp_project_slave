///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.3.6832/W32 for ARM       15/Sep/2015  15:49:07
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  F:\meterModuleFSK\STM32F051_contiki_8M\APP\sx1276-LoRa.c
//    Command line =  
//        F:\meterModuleFSK\STM32F051_contiki_8M\APP\sx1276-LoRa.c -D
...
//    List file    =  
//        F:\meterModuleFSK\STM32F051_contiki_8M\Debug\List\sx1276-LoRa.s
//
///////////////////////////////////////////////////////////////////////////////
...
SX1276LoRaGetTimeOnAir:
        ...
        BL       __aeabi_ui2d
        MOVS     R2,#+0
        LDR      R3,??DataTable17_3  ;; 0x40110000
        BL       __aeabi_dadd
        ADD      R2,SP,#+8
        STM      R2!,{R0,R1}
        SUBS     R2,R2,#+8
...
SX1276LoRaSetWokeUpPreambleLenth:
        ...
        BL       __aeabi_ui2d
        MOVS     R2,#+0
        LDR      R3,??DataTable20_2  ;; 0x3ff00000
        BL       __aeabi_dmul
        MOVS     R2,R4
        MOVS     R3,R5
        BL       __aeabi_ddiv
        MOVS     R2,#+0
        LDR      R3,??DataTable20_3  ;; 0x40340000
        BL       __aeabi_dadd
        BL       __aeabi_d2uiz
        LDR      R1,??DataTable21
        STR      R0,[R1, #+0]
...
SX1276LoRaGetTxTimeOut:
        ...
        MOVS     R2,#+0
        LDR      R3,??DataTable21_1  ;; 0x3ff80000
        BL       __aeabi_dmul
        BL       __aeabi_d2uiz
        POP      {R1,PC}          ;; return
...
SX1276LoRaReadRssi:
        ...
        LDR      R0,??DataTable17_2
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable22_4  ;; 0x33428f00
        CMP      R0,R1
        ...
        BL       __aeabi_ui2d
        MOVS     R2,#+0
        LDR      R3,??DataTable22_5  ;; 0xc0648000
        BL       __aeabi_dadd
...
SX1276LoRaInit:
        ...
        BL       SX1276LoRaGetSymbolTs
        MOVS     R2,#+0
        LDR      R3,??DataTable26_4  ;; 0x40300000
        BL       __aeabi_cdrcmple
...
??SX1276LoRa_Send_Packet_2:
        MOVS     R0,#+3
        BL       SX1276LoRaSetOpMode
        LDR      R2,??DataTable28_5
        MOVS     R1,#+134
        LDR      R0,??DataTable29_3
        BL       process_post
        POP      {R0,R4,R5,PC}    ;; return
...
SX1276LoRa_Receive_Packet:
        ...
        BL       SX1276LoRaSetOpMode
        MOVS     R0,#+255
        LDR      R1,??DataTable29_5
        LDR      R1,[R1, #+0]
        STRB     R0,[R1, #+17]
        LDR      R0,??DataTable29_5
        LDR      R0,[R0, #+0]
        LDRB     R0,[R0, #+17]
        MOVS     R1,#+143
        ANDS     R1,R1,R0
...
??EXTI4_15_IRQHandler_0:
        ...
        BL       EXTI_GetITStatus
        CMP      R0,#+0
        BEQ      ??EXTI4_15_IRQHandler_8
        MOVS     R0,#+128
        LSLS     R0,R0,#+5        ;; #+4096
        BL       EXTI_ClearITPendingBit
??EXTI4_15_IRQHandler_8:
        MOVS     R0,#+128
        LSLS     R0,R0,#+4        ;; #+2048
        BL       EXTI_GetITStatus
        CMP      R0,#+0
        BEQ      ??EXTI4_15_IRQHandler_9
        MOVS     R0,#+128
        LSLS     R0,R0,#+4        ;; #+2048
        BL       EXTI_ClearITPendingBit
        LDR      R0,??DataTable30_4
        ...
        LDRB     R0,[R0, #+18]
        LSLS     R0,R0,#+30
        BPL      ??EXTI4_15_IRQHandler_9
        MOVS     R1,#+2
        MOVS     R0,#+18
        BL       SX1276Write
        BL       SX1276LoRaReadRxGain
        LDR      R1,??DataTable30_11
        STRB     R0,[R1, #+0]
        LDR      R0,??DataTable30_4
        LDR      R1,[R0, #+0]
        ADDS     R1,R1,#+28
        ...
        LDR      R0,[R0, R1]
        BL       SX1276LoRaSetRFFrequency
??EXTI4_15_IRQHandler_9:
        MOVS     R0,#+128
        LSLS     R0,R0,#+3        ;; #+1024
        BL       EXTI_GetITStatus
        CMP      R0,#+0
        BEQ      ??EXTI4_15_IRQHandler_10
        MOVS     R0,#+128
        LSLS     R0,R0,#+3        ;; #+1024
        BL       EXTI_ClearITPendingBit
        MOVS     R1,#+0
        ...
        LDRB     R0,[R0, #+0]
        CMP      R0,#+2
        BNE      ??EXTI4_15_IRQHandler_11
        MOVS     R0,#+14
        LDR      R1,??DataTable30_1
        STRB     R0,[R1, #+0]
??EXTI4_15_IRQHandler_11:
        MOVS     R0,#+1
        LDR      R1,??DataTable30_13
        STRB     R0,[R1, #+0]
??EXTI4_15_IRQHandler_10:
        POP      {R0,PC}          ;; return
